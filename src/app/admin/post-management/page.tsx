    ...
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="border border-gray-200 rounded-sm p-8 shadow-sm">
            <div className="mb-4 text-[#43c4ba]">
              {/* Briefcase Icon */}
            ...
            <div className="space-y-4">
              <div className="bg-[#f4f4f4] rounded-3xl px-6 py-4">
                <h3 className="font-bold text-gray-900 text-sm mb-1">Webinar: Cloud Computing dengan AWS</h3>
                <p className="text-xs text-gray-500">Diposting oleh Admin • 20 Mei 2026</p>
              </div>
              <div className="bg-[#f4f4f4] rounded-3xl px-6 py-4">
                <h3 className="font-bold text-gray-900 text-sm mb-1">Bootcamp: Full-Stack Web Development</h3>
                <p className="text-xs text-gray-500">Diposting oleh Admin • Segera</p>
              </div>
              <div className="bg-[#f4f4f4] rounded-3xl px-6 py-4">
                <h3 className="font-bold text-gray-900 text-sm mb-1">Webinar: Cybersecurity Fundamentals</h3>
                <p className="text-xs text-gray-500">Diposting oleh Admin • 15 April 2026</p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-sm p-8 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="bg-[#f4f4f4] rounded-3xl px-6 py-4">
                <h3 className="font-bold text-gray-900 text-sm mb-1">Magang: Frontend Developer</h3>
                <p className="text-xs text-gray-500">PT Teknologi Maju • Jakarta Selatan</p>
              </div>
              <div className="bg-[#f4f4f4] rounded-3xl px-6 py-4">
                <h3 className="font-bold text-gray-900 text-sm mb-1">Magang: Data Analyst</h3>
                <p className="text-xs text-gray-500">EduTech Indonesia • Remote</p>
              </div>
            </div>
          </div>
